...
<script type="text/javascript" src="${base}/admin/js/jquery.validate.cn.js"></script>
<script type="text/javascript" src="${base}/admin/js/jquery.validate.methods.js"></script>
