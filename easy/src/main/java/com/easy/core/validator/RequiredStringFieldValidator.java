 ...
 */
public class RequiredStringFieldValidator extends
		AbstractFieldValidator<RequiredStringValidator> {
	 ...
	 */
	@Override
	public ValidatorResult isValid(RequiredStringValidator validator,
		...
		for (String value : values) {
			if (value == null
					|| (validator.trim() && value.trim().length() == 0)) {
				return failResult;
			}
		}
